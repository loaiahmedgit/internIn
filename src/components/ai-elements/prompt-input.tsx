...
// This project's installed @base-ui/react wraps native events (extra
// preventBaseUIHandler method) — a real version difference from what this
// registry component was generated against, not app logic. Deriving the
// handler's parameter type from the prop itself (instead of the plain DOM
// `Event` the original code assumed) keeps these callbacks correctly typed
// either way.
