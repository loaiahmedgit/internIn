      ...
      <Tabs defaultValue="overview" className="flex h-full min-h-0 flex-col gap-0">
        <div className="shrink-0 border-b border-navy/8 p-5 sm:p-6">
          ...
          <TabsList variant="line" className="mt-4 h-auto w-full justify-start gap-4 p-0">
            ...
            {detail.whatYouWillLearn && <TabsTrigger value="learn" className="h-9 flex-none px-0.5 text-sm data-active:font-medium data-active:text-teal-ink">What you&apos;ll learn</TabsTrigger>}
          </TabsList>
        </div>
        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          ...
          {detail.whatYouWillLearn && (
            <TabsContent value="learn" className="p-5 sm:p-6">
