...
/** The one custom data part this app streams; keyed by `id` so a step's
 * status can flip from "active" to "complete" via a second write with the
 * same id (AI SDK v5 data-part reconciliation). */
